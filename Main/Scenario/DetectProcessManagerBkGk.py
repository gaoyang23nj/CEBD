...
class DetectProcessManagerBkGk(object):
    ...
    def __init__(self, direct_model_file_path, indirect_model_file_path):
        ...
        if not (os.path.exists(direct_model_file_path) and os.path.exists(indirect_model_file_path)):
            print('detect model do not exist, {}, {}'.format(direct_model_file_path, indirect_model_file_path))
