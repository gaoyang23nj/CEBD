...
def train_for_RWP_dataset():
    ...
    h5_direct_filepath = os.path.join(ml_dir, "our_direct_model_1_CART.pkl")
    h5_indirect_filepath = os.path.join(ml_dir, "our_indirect_model_1_CART.pkl")
...
if __name__ == "__main__":
    print('CART classify and average!..')
    
    #==========================    shanghai trace blackhole node 检测模型的训练 ====================================#
    # train_for_shanghai_dataset()

    #==========================    RWP trace blackhole node CART 检测模型的训练 ====================================#
